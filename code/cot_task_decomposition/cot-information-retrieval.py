...
for data_folder in data_folders:
    for prediction_folder,model in zip(prediction_folders,models):
        ...
        with open(f'data/{data_folder}/multi-stage-cot-examples/few_shot_example.json','r') as f:
            few_shot_timeline = json.load(f)
        with open(f'data/{data_folder}/multi-stage-cot-examples/COT_questions.json','r') as f:
            ...
            for questions_category in entities[entity]:
                for question in entities[entity][questions_category]:
                    ...
                    prompt = create_prompt(few_shot_timeline,cot_questions['Q1'],
                                       ...
                                       cot_questions['Q2'],cot_questions['A2-Task1'],
                                       cot_questions['A2-Task2'],cot_questions['Q3'],
                    ...
                    tasks.append(task)
        file_name = f"data/{data_folder}/new_predictions/multi-stage/cot/two-stage(table)/{prediction_folder}/batch-questions-new-gpt-4o.jsonl"
        ...
        if batch_job_status.status == "completed":
            ...
            result_file_name = f"data/{data_folder}/new_predictions/multi-stage/cot/two-stage(table)/{prediction_folder}/batch-results.jsonl"
